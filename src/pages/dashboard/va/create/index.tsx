      ...
      <Box mx="auto" mt={8} borderWidth="1px" borderRadius="lg" p={8}>
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="flex flex-col justify-center space-y-2 py-2">
            ...
            <Box mb={4}>
              <Input type="text" id="name" {...register("title", { required: true })} />
            </Box>
          ...
          <div className="flex flex-col justify-center space-y-2 py-2">
            ...
            <Box mb={4}>
              <Input type="text" id="notes" {...register("description", { required: true })} />
            </Box>
            {errors.description && <Text color="red.500">This field is required</Text>}
          </div>
          <div className="flex flex-col justify-center space-y-2 py-2">
            <label htmlFor="price">Transaction Amount</label>
            <Box mb={4}>
              <Input type="number" id="price" {...register("transaction_amount", { required: true })} />
            </Box>
