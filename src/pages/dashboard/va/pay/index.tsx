            ...
            {confirmationData && (
                <Box mx="auto" mt={8} borderWidth="1px" borderRadius="lg" p={8}>
                    ...
                    <div className="flex flex-col justify-center space-y-2 py-2">
                        ...
                        <Box mb={4}>
                            <Input type="text" id="payment_id" value={confirmationData.payment_id} disabled />
                        </Box>
                        </div>
                    <div className="flex flex-col justify-center space-y-2 py-2">
                        <label htmlFor="amount">Amount</label>
                        <Box mb={4}>
                            <Input type="text" id="amount" value={confirmationData.amount} disabled />
                        </Box>
                        </div>
                    <div className="flex flex-col justify-center space-y-2 py-2">
                        <label htmlFor="remaining_balance">Remaining Balance</label>
                        <Box mb={4}>
                            <Input type="text" id="remaining_balance" value={confirmationData.remaining_balance} disabled />
                        </Box>
                        </div>
                    </Box>
            )}
